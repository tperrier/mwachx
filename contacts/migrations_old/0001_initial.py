    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.CharField(max_length=15, choices=[(b'mathare', b'Mathare'), (b'bondo', b'Bondo'), (b'ahero', b'Ahero'), (b'siaya', b'Siaya'), (b'rachuonyo', b'Rachuonyo'), (b'riruta', b'Riruta')])),
                ...
                ('status', models.CharField(default=b'pregnant', max_length=15, choices=[(b'pregnant', b'Pregnant'), (b'over', b'Post-Date'), (b'post', b'Post-Partum'), (b'ccc', b'CCC'), (b'completed', b'Completed'), (b'stopped', b'Withdrew'), (b'loss', b'SAE opt-in'), (b'sae', b'SAE opt-out'), (b'other', b'Admin Stop'), (b'quit', b'Left Study')])),
                ('language', models.CharField(default=b'english', max_length=10, choices=[(b'english', b'English'), (b'luo', b'Luo'), (b'swahili', b'Swahili')])),
                ('condition', models.CharField(default=b'normal', max_length=15, choices=[(b'art', b'1 - Starting ART'), (b'adolescent', b'2 - Adolescent'), (b'first', b'3 - First Time Mother'), (b'normal', b'4 -  Normal'), (b'multiple', b'5 - Twins')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(blank=True, to=swapper.get_model_name('contacts', 'Contact'), null=True)),
            ],
        ),
        migrations.CreateModel(
            name='EventLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant', models.ForeignKey(to=swapper.get_model_name('contacts', 'Contact'))),
            ],
            options={
                'ordering': ('-created',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_user', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('connection', models.ForeignKey(to='contacts.Connection')),
                ('contact', models.ForeignKey(to=swapper.get_model_name('contacts', 'Contact'))),
            ],
            options={
                'ordering': ('-created',),
            },
