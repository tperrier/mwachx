...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='contact',
            name='study_group',
            field=models.CharField(default=b'two-way', max_length=10, verbose_name=b'Group', blank=True, choices=[(b'control', b'Control'), (b'one-way', b'One Way'), (b'two-way', b'Two Way')]),
        ),
    ]
